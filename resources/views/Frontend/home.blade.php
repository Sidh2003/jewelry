            ...
            <div id="primary" class="content-area">
               ...
               <div class="item-content">
                <div class="content-image">
                 <img width="1920" height="1080" src="/frontend/media/slider/1-1.jpg" alt="Image Slider">
                </div>
                <div class="item-info horizontal-start vertical-middle">
                 <div class="content">
                  <h2 class="title-slider">Discover a <br>world of jewelry</h2>
                  <a class="button-slider button button-white button-outline thick-border" href="#0">Explore Bestseller</a>
                 </div>
                </div>
               </div>
              </div> -->
               ...
               <div class="item-content">
                <div class="content-image">
                 <img width="1920" height="1080" src="/frontend/media/slider/1-2.jpg" alt="Image Slider">
                </div>
                <div class="item-info horizontal-start vertical-middle">
                 <div class="content">
                  ...
                  <a class="button-slider button button-white button-outline thick-border" href="#0">Explore Bestseller</a>
                                ...
                                <div class="item slick-slide">
                                    <div class="item-content">
                                        <div class="content-image">
                                            <img width="1920" height="1080" src="/frontend/media/slider/1-3.jpg"
                                                alt="Image Slider">
                                        </div>
                                        <div class="item-info horizontal-start vertical-middle">
                                            <div class="content">
                                                        ...
                                                        <div class="banner-image">
                                                            <a href="#0">
                                                                <img width="630" height="457"
                                                                    src="/frontend/media/banner/banner-1-1.jpg"
                                                                    alt="Banner Image">
                                                            </a>
                                                        </div>
                                                        <div class="banner-wrapper-infor">
                                                            <div class="info">
                                                                <div class="content">
                                                                    ...
                                                                    <a class="button" href="#0">Shop Now</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="banner-image">
                                                            <a href="#0">
                                                                <img width="450" height="457"
                                                                    src="/frontend/media/banner/banner-1-2.jpg"
                                                                    alt="Banner Image">
                                                            </a>
                                                        </div>
                                                        <div class="banner-wrapper-infor text-center">
                                                            <div class="info">
                                                                <div class="content">
                                                                    ...
                                                                    <a class="button center" href="#0">Shop Now</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="bg-banner">
                                                    <div class="banner-wrapper banners">
                                                        <div class="banner-image">
                                                            <a href="#0">
                                                                <img width="630" height="457"
                                                                    src="/frontend/media/banner/banner-1-3.jpg"
                                                                    alt="Banner Image">
                                                            </a>
                                                        </div>
                                                        <div class="banner-wrapper-infor">
                                                        ...
                                                        <a href="#0">
                                                            <div class="item-image animation-horizontal">
                                                                <img width="258" height="258"
                                                                    src="/frontend/media/product/cat-1.jpg"
                                                                    alt="Bracelets">
                                                            </div>
                                                        </a>
                                                ...
                                                <div class="item item-product-cat slick-slide">
                                                    <div class="item-product-cat-content">
                                                        <a href="#0">
                                                            <div class="item-image animation-horizontal">
                                                                <img width="258" height="258"
                                                                    src="/frontend/media/product/cat-2.jpg"
                                                                    alt="Charms">
                                                            </div>
                                                        </a>
                                                        <div class="product-cat-content-info">
                                                ...
                                                <div class="item item-product-cat slick-slide">
                                                    <div class="item-product-cat-content">
                                                        <a href="#0">
                                                            <div class="item-image animation-horizontal">
                                                                <img width="258" height="258"
                                                                    src="/frontend/media/product/cat-3.jpg"
                                                                    alt="Earrings">
                                                            </div>
                                                        </a>
                                                        <div class="product-cat-content-info">
                                                ...
                                                <div class="item item-product-cat slick-slide">
                                                    <div class="item-product-cat-content">
                                                        <a href="#0">
                                                            <div class="item-image animation-horizontal">
                                                                <img width="258" height="258"
                                                                    src="/frontend/media/product/cat-4.jpg"
                                                                    alt="Necklaces">
                                                            </div>
                                                        </a>
                                                        <div class="product-cat-content-info">
                                                ...
                                                <div class="item item-product-cat slick-slide">
                                                    <div class="item-product-cat-content">
                                                        <a href="#0">
                                                            <div class="item-image animation-horizontal">
                                                                <img width="258" height="258"
                                                                    src="/frontend/media/product/cat-5.jpg"
                                                                    alt="Rings">
                                                            </div>
                                                        </a>
                                                        <div class="product-cat-content-info">
                                    ...
                                    <div class="intro-wrap">
                                        ...
                                        <div class="intro-item">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text">Nullam quis ante. Pellentesque libero tortor, tincidunt
                                                    et, tinciduntamet est.In hac habitasse platea dictumst. Praesent nec
                                                    nisl a purus blandit viverra</div>
                                            </div>
                                        </div>
                                        <div class="intro-item">
                                            <div class="icon">
                                        ...
                                        <div class="intro-btn">
                                            <a href="#0"
                                                class="button button-black button-arrow animation-horizontal">LEARN
                                                MORE</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="section-column right">
                                    <a href="#">
                                        <img class="hover-opacity" width="820" height="674"
                                            src="/frontend/media/banner/intro-1.jpg" alt="intro">
                                    </a>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <div class="products-entry clearfix product-wapper">
                                                            <div class="products-thumb">
                                                                ...
                                                                <div class="product-thumb-hover">
                                                                    <a href="#0">
                                                                        <img width="600" height="600"
                                                                            src="/frontend/media/product/1.jpg"
                                                                            class="post-image" alt="">
                                                                        <img width="600" height="600"
                                                                            src="/frontend/media/product/1-2.jpg"
                                                                ...
                                                                <div class="product-button">
                                                                    ...
                                                                    <span class="product-quickview"
                                                                        ...
                                                                        <a href="#"
                                                                            class="quickview quickview-button">Quick View
                                                            ...
                                                            <div class="products-content">
                                                                <div class="contents">
                                                                    ...
                                                                    <h3 class="product-title"><a href="#0">Medium
                                                                            Flat Hoops</a></h3>
                                                        ...
                                                        <div class="products-entry clearfix product-wapper">
                                                            <div class="products-thumb">
                                                                ...
                                                                <div class="product-thumb-hover">
                                                                    <a href="#0">
                                                                        <img width="600" height="600"
                                                                            src="/frontend/media/product/2.jpg"
                                                                            class="post-image" alt="">
                                                                        <img width="600" height="600"
                                                                            src="/frontend/media/product/2-2.jpg"
                                                                            class="hover-image back" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="product-button">
                                                            ...
                                                            <div class="products-content">
                                                                <div class="contents">
                                                                    ...
                                                                    <h3 class="product-title"><a href="#0">Bold Pearl
                                                                            Hoop Earrings</a></h3>
                                                                    <span class="price">
                                                        ...
                                                        <div class="products-entry clearfix product-wapper">
                                                            <div class="products-thumb">
                                                                ...
                                                                <div class="product-thumb-hover">
                                                                    <a href="#0">
                                                                        <img width="600" height="600"
                                                                            src="/frontend/media/product/3.jpg"
                                                                            class="post-image" alt="">
                                                                        <img width="600" height="600"
                                                                            src="/frontend/media/product/3-2.jpg"
                                                                            class="hover-image back" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="product-button">
                                                            ...
                                                            <div class="products-content">
                                                                <div class="contents">
                                                                    ...
                                                                    <h3 class="product-title"><a href="#0">Twin
                                                                            Hoops</a></h3>
                                                        ...
                                                        <div class="products-entry clearfix product-wapper">
                                                            <div class="products-thumb">
                                                                ...
                                                                <div class="product-thumb-hover">
                                                                    <a href="#0">
                                                                        <img width="600" height="600"
                                                                            src="/frontend/media/product/4.jpg"
                                                                            class="post-image" alt="">
                                                                        <img width="600" height="600"
                                                                            src="/frontend/media/product/4-2.jpg"
                                                                            class="hover-image back" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="product-button">
                                                            ...
                                                            <div class="products-content">
                                                                <div class="contents">
                                                                    <div class="rating">
                                                                        <div class="star star-4"></div><span
                                                                            class="count">(2 reviews)</span>
                                                                    </div>
                                                                    <h3 class="product-title"><a href="#0">Yilver And
                                                        ...
                                                        <div class="products-entry clearfix product-wapper">
                                                            <div class="products-thumb">
                                                                ...
                                                                <div class="product-thumb-hover">
                                                                    <a href="#0">
                                                                        <img width="600" height="600"
                                                                            src="/frontend/media/product/13.jpg"
                                                                            class="post-image" alt="">
                                                                        <img width="600" height="600"
                                                                            src="/frontend/media/product/13-2.jpg"
                                                                            class="hover-image back" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="product-button">
                                                        ...
                                                        <div class="banner-image">
                                                            <a href="#0">
                                                                <img width="856" height="496"
                                                                    src="/frontend/media/banner/banner-1-4.jpg"
                                                                    alt="Banner Image">
                                                            </a>
                                                        </div>
                                                        <div class="banner-wrapper-infor">
                                                ...
                                                <div class="bg-banner">
                                                    <div class="banner-wrapper banners">
                                                        <div class="banner-image">
                                                            <a href="#0">
                                                                <img width="856" height="496"
                                                                    src="/frontend/media/banner/banner-1-5.jpg"
                                                                    alt="Banner Image">
                                                            </a>
                                                        </div>
                                                        <div class="banner-wrapper-infor">
                                                        ...
                                                        <div class="testimonial-image image-position-top">
                                                            <div class="thumbnail">
                                                                <img width="110" height="110"
                                                                    src="/frontend/media/testimonial/1.jpg"
                                                                    alt="">
                                                            </div>
                                                ...
                                                <div class="testimonial-content">
                                                    <div class="item">
                                                        ...
                                                        <div class="testimonial-image image-position-top">
                                                            <div class="thumbnail">
                                                                <img width="110" height="110"
                                                                    src="/frontend/media/testimonial/2.jpg"
                                                                    alt="">
                                                            </div>
                                                            <div class="testimonial-info">
                                                ...
                                                <div class="testimonial-content">
                                                    <div class="item">
                                                        ...
                                                        <div class="testimonial-image image-position-top">
                                                            <div class="thumbnail">
                                                                <img width="110" height="110"
                                                                    src="/frontend/media/testimonial/3.jpg"
                                                                    alt="">
                                                            </div>
                                                            <div class="testimonial-info">
                                                ...
                                                <div class="testimonial-content">
                                                    <div class="item">
                                                        ...
                                                        <div class="testimonial-image image-position-top">
                                                            <div class="thumbnail">
                                                                <img width="110" height="110"
                                                                    src="/frontend/media/testimonial/4.jpg"
                                                                    alt="">
                                                            </div>
                                                            <div class="testimonial-info">
                                                ...
                                                <div class="item-image animation-horizontal">
                                                    <a href="#">
                                                        <img width="450" height="450"
                                                            src="/frontend/media/brand/1.jpg" alt="Brand 1">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="item slick-slide">
                                                <div class="item-image animation-horizontal">
                                                    <a href="#">
                                                        <img width="450" height="450"
                                                            src="/frontend/media/brand/2.jpg" alt="Brand 2">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="item slick-slide">
                                                <div class="item-image animation-horizontal">
                                                    <a href="#">
                                                        <img width="450" height="450"
                                                            src="/frontend/media/brand/3.jpg" alt="Brand 3">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="item slick-slide">
                                                <div class="item-image animation-horizontal">
                                                    <a href="#">
                                                        <img width="450" height="450"
                                                            src="/frontend/media/brand/4.jpg" alt="Brand 4">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="item slick-slide">
                                                <div class="item-image animation-horizontal">
                                                    <a href="#">
                                                        <img width="450" height="450"
                                                            src="/frontend/media/brand/5.jpg" alt="Brand 5">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
