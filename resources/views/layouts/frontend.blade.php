...
<head>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" type="image/x-icon" href="/frontend/my-img/logo.png">
		
		<!-- Dependency Styles -->
		<link rel="stylesheet" href="/frontend/libs/bootstrap/css/bootstrap.min.css" type="text/css">
		<link rel="stylesheet" href="/frontend/libs/feather-font/css/iconfont.css" type="text/css">
		<link rel="stylesheet" href="/frontend/libs/icomoon-font/css/icomoon.css" type="text/css">
		<link rel="stylesheet" href="/frontend/libs/font-awesome/css/font-awesome.css" type="text/css">
		<link rel="stylesheet" href="/frontend/libs/wpbingofont/css/wpbingofont.css" type="text/css">
		<link rel="stylesheet" href="/frontend/libs/elegant-icons/css/elegant.css" type="text/css">
		<link rel="stylesheet" href="/frontend/libs/slick/css/slick.css" type="text/css">
		<link rel="stylesheet" href="/frontend/libs/slick/css/slick-theme.css" type="text/css">
		<link rel="stylesheet" href="/frontend/libs/mmenu/css/mmenu.min.css" type="text/css">
...
<img width="400" height="79" 
     src="/frontend/my-img/logo.png" 
     alt="Mojuri – Jewelry Store HTML Template" 
     style="width: 130px !important; height: auto !important; display: block !important; max-width: none !important;" />
										</a>
									</div>
								</div>
					...
					<div class="header-mobile-fixed">
						<!-- Shop -->
						<div class="shop-page">
							<a href="#0"><i class="wpb-icon-shop"></i></a>
						</div>

						<!-- Login -->
						<div class="my-account">
							<div class="login-header">
								<a href="#0"><i class="wpb-icon-user"></i></a>
							</div>
						</div>
						...
						<div class="wishlist-box">
							<a href="#0"><i class="wpb-icon-heart"></i></a>
						</div>
					</div>
				</div>
     ...
     alt="Mojuri – Jewelry Store HTML Template" 
     style="width: 160px !important; height: auto !important; display: block !important; max-width: none !important;" />
											</a>
										</div>
									</div>
											...
											<nav id="main-navigation">
												<ul id="menu-main-menu" class="menu">
													<li class="level-0 menu-item">
														<a href="#0"><span class="menu-item-text">Home</span></a>
													</li>
													<li class="level-0 menu-item">
														<a href="#0"><span class="menu-item-text">About Us</span></a>
													</li>
                                                    <li class="level-0 menu-item">
														<a href="#0"><span class="menu-item-text">Products</span></a>
													</li>
												
													<li class="level-0 menu-item">
														<a href="#0"><span class="menu-item-text">Contact</span></a>
													</li>
												</ul>
											</nav>
										</div>
										...
										<div class="block block-menu">
											...
											<div class="block-content">
												<ul>
													...
													<li>
														<a href="#0">Product Care & Repair</a>
													</li>
													<li>
														<a href="#0">Book an Appointment</a>
													</li>
													<li>
														<a href="#0">Frequently Asked Questions</a>
													</li>
													<li>
									...
									<div class="col-md-6">
										<div class="footer-right">
											<div class="block block-image">
												<img width="309" height="32" src="/frontend/media/payments.png" alt="">
											</div>
										</div>
									</div>
								</div>
							...
							<tbody>
								<tr class="wishlist-item">
									...
									<td class="wishlist-item-image">
                                    	<a href="#0">
											<img width="600" height="600" src="/frontend/media/product/3.jpg" alt="">                                        
										</a>
		                       		</td>
			                        <td class="wishlist-item-info">
										<div class="wishlist-item-name">
											<a href="#0">Twin Hoops</a>
										</div>
								...
								<tr class="wishlist-item">
									...
									<td class="wishlist-item-image">
                                    	<a href="#0">
											<img width="600" height="600" src="/frontend/media/product/4.jpg" alt="">                                        
										</a>
		                       		</td>
			                        <td class="wishlist-item-info">
										<div class="wishlist-item-name">
											<a href="#0">Yilver And Turquoise Earrings</a>
										</div>
										<div class="wishlist-item-price">
                    		...
                    		<table id="product-table" class="product-table">
                    			<thead>
                    				<tr>
                    					...
                    					<th>
                    						<a href="#0">Twin Hoops</a> <span class="remove">remove</span>
                    					</th>
                    					<th>
                    						<a href="#0">Medium Flat Hoops</a> <span class="remove">remove</span>
                    					</th>
                    					<th>
                    						<a href="#0">Bold Pearl Hoop Earrings</a> <span class="remove">remove</span>
                    					</th>
                    				</tr>
                    			</thead>
                    			<tbody>
                    				<tr class="tr-image">
                    					...
                    					<td>
                    						<a href="#0">
                    							<img width="600" height="600" src="/frontend/media/product/1.jpg" alt="">
                    						</a>
                    					</td>
                    					<td>
                    						<a href="#0">
                    							<img width="600" height="600" src="/frontend/media/product/2.jpg" alt="">
                    						</a>
                    					</td>
                    				</tr>
                    				<tr class="tr-sku">
													...
													<div class="slick-wrap">
														<div class="slick-sliders image-additional" data-dots="true" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1" data-nav="true">
															<div class="img-thumbnail slick-slide"> 
																<a href="/frontend/media/product/3.jpg" class="image-scroll" title="">
																	<img width="900" height="900" src="/frontend/media/product/3.jpg" alt="">
																</a> 
															</div>
															<div class="img-thumbnail slick-slide"> 
																<a href="/frontend/media/product/3-2.jpg" class="image-scroll" title="">
																	<img width="900" height="900" src="/frontend/media/product/3-2.jpg" alt="">
																</a> 
															</div>
														</div>
													</div>
		...
		<div class="newsletter-popup">
			...
			<div class="newsletter-container"> 
				<div class="newsletter-img">
					<img src="/frontend/media/banner/newsletter-popup.jpg" alt="">
				</div> 
		...
		<!-- Dependency Scripts -->
		<script src="/frontend/libs/popper/js/popper.min.js"></script>
		<script src="/frontend/libs/jquery/js/jquery.min.js"></script>
		<script src="/frontend/libs/bootstrap/js/bootstrap.min.js"></script>
		<script src="/frontend/libs/slick/js/slick.min.js"></script>
		<script src="/frontend/libs/mmenu/js/jquery.mmenu.all.min.js"></script>
		
		<!-- Site Scripts -->
		<script src="/frontend/assets/js/app.js"></script>
	</body>

<!-- Mirrored from caketheme.com/html/mojuri/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jun 2026 06:27:48 GMT -->
</html>